 ...
 */
public class TreeViewDisplay extends Display {

    //public static final String TREE_CHI = "/chi-ontology.xml.gz";
    public static final String TREE_CHI = "C:\\Java\\NetBeansProjects\\PrefuseTest\\src\\lattes_representation.xml";
    ...
    private static String xml_string = null;
    
    public TreeViewDisplay(Tree t, String label) {
    ...
    public static void main(String argv[]) {
        ...
        JFrame frame = new JFrame("Curriculo Lattes");
    ...
    public static void showTreeDisplay(String xml){
        String infile = TREE_CHI;
        String label = "name";
        
        JComponent treeview = demo(infile, label, xml);
    ...
    public static JComponent demo(String datafile, final String label) {
        return demo(datafile, label, null);
    }
    
    public static JComponent demo(String datafile, final String label, final String xml) {
        ...
        try {
            ...
            if (xml == null) {
                t = (Tree)new TreeMLReader().readGraph(f);
            } else {
        ...
        final TreeViewDisplay tview = new TreeViewDisplay(t, label);
