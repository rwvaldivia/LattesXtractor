...
#
*/
package br.xtractor.lattes.task;

import br.xtractor.lattes.app.ScriptLattesXmlParser;
 ...
 */
public abstract class XtractorTask {
    private CurriculoLattes cv = null;
    
    public XtractorTask(String fileNamePath) throws IOException {
        ScriptLattesXmlParser sl = new ScriptLattesXmlParser(fileNamePath);
        this.setCurriculoLattes(sl.parse());
    }
    ...
    public void setCurriculoLattes(CurriculoLattes cv){
        this.cv = cv;
    }
