...
public class OrientacaoTccConcluida {
    private List<TccVO> orientacoesTccConcluidas;

    public List<TccVO> getOrientacoesTccConcluidas() {
        return orientacoesTccConcluidas;
    }

    public void setOrientacoesTccConcluidas(List<TccVO> orientacoesTccConcluidas) {
