 ...
 * @author richardv
 */
public class TextosEmJornal {
    private List<TextoJornalVO> textosEmJornal;

    public List<TextoJornalVO> getTextosEmJornal() {
        return textosEmJornal;
    }

    public void setTextosEmJornal(List <TextoJornalVO> textosEmJornal) {
