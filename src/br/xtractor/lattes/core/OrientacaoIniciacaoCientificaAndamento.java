...
public class OrientacaoIniciacaoCientificaAndamento {
    private List<IniciacaoCientificaVO> orientacoesIniciacaoCientificaAndamento;

    public List<IniciacaoCientificaVO> getOrientacoesIniciacaoCientificaAndamento() {
        return orientacoesIniciacaoCientificaAndamento;
    }

    public void setOrientacoesIniciacaoCientificaAndamento(List<IniciacaoCientificaVO> orientacoesIniciacaoCientificaAndamento) {
