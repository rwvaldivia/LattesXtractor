...
public class OrientacaoMestradoConcluido {
    private List <DissertacaoVO> orientacoesMestradoConcluidos;

    public List<DissertacaoVO> getOrientacoesMestradoConcluidos() {
        return orientacoesMestradoConcluidos;
    }

    public void setOrientacoesMestradoConcluidos(List<DissertacaoVO> orientacoesMestradoConcluidos) {
