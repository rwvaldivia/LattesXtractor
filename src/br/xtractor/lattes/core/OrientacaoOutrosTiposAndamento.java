...
public class OrientacaoOutrosTiposAndamento {
    private List<OrientacaoOutrosTiposVO> orientacaoOutrosTiposAndamento;

    public List<OrientacaoOutrosTiposVO> getOrientacaoOutrosTiposAndamento() {
        return orientacaoOutrosTiposAndamento;
    }

    public void setOrientacaoOutrosTiposAndamento(List<OrientacaoOutrosTiposVO> orientacaoOutrosTiposAndamento) {
