...
public class OrientacaoEspecializacaoConcluida {
    private List <MonografiaVO> orientacoesEspecializacaoConcluidos;

    public List<MonografiaVO> getOrientacoesEspecializacaoConcluidos() {
        return orientacoesEspecializacaoConcluidos;
    }

    public void setOrientacoesEspecializacaoConcluidos(List<MonografiaVO> orientacoesEspecializacaoConcluidos) {
