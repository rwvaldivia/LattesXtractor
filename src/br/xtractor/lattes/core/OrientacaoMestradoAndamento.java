...
public class OrientacaoMestradoAndamento {
    
    private List <DissertacaoVO> orientacaoMestradoAndamento;

    public List<DissertacaoVO> getOrientacaoMestradoAndamento() {
        return orientacaoMestradoAndamento;
    }

    public void setOrientacaoMestradoAndamento(List<DissertacaoVO> orientacaoMestradoAndamento) {
        this.orientacaoMestradoAndamento = orientacaoMestradoAndamento;
    }
