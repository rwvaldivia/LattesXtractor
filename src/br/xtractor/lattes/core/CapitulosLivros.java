...
public class CapitulosLivros {
    private List <CapitulosLivrosVO> capitulosLivros;

    public List<CapitulosLivrosVO> getCapitulosLivros() {
        return capitulosLivros;
    }

    public void setCapitulosLivros(List<CapitulosLivrosVO> capitulosLivros) {
