...
public class SoftwareComPatente {
    private List<SoftwareComPatente> softwareComPatente;

    public List<SoftwareComPatente> getSoftwareComPatente() {
        return softwareComPatente;
    }

    public void setSoftwareComPatente(List<SoftwareComPatente> softwareComPatente) {
