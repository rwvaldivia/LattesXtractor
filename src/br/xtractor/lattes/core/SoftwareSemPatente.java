 ...
 * @author richardv
 */
public class SoftwareSemPatente {
    private List<SoftwareVO> softwareSemPatente;

    public List<SoftwareVO> getSoftwareSemPatente() {
        return softwareSemPatente;
    }

    public void setSoftwareSemPatente(List<SoftwareVO> softwareSemPatente) {
