...
public class FormacaoAcademica {
    private List<FormacaoVO> formacao;

    public List<FormacaoVO> getFormacao() {
        return formacao;
    }

    public void setFormacao(List<FormacaoVO> formacao) {
        this.formacao = formacao;
    }
    
    public void addFormacao(FormacaoVO vo){
        if (this.formacao == null){
            this.formacao = new ArrayList<FormacaoVO>();
        }
        this.formacao.add(vo);
    }
