...
public class LivrosPublicados {
    private List <LivroPublicadoVO> livrosPublicados;

    public List<LivroPublicadoVO> getLivrosPublicados() {
        return livrosPublicados;
    }

    public void setLivrosPublicados(List<LivroPublicadoVO> livrosPublicados) {
