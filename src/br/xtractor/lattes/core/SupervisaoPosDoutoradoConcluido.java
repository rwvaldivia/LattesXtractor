 ...
 * @author richardv
 */
public class SupervisaoPosDoutoradoConcluido {
    List<SupervisaoVO> supervisaoPosDoutConcluido;

    public List<SupervisaoVO> getSupervisaoPosDoutConcluido() {
        return supervisaoPosDoutConcluido;
    }

    public void setSupervisaoPosDoutConcluido(List<SupervisaoVO> supervisaoPosDoutConcluido) {
