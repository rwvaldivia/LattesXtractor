 ...
 * @author richardv
 */
public class TrabalhosTecnicos {
    List<TrabalhoTecnicoVO> trabalhosTecnicos;

    public List<TrabalhoTecnicoVO> getTrabalhosTecnicos() {
        return trabalhosTecnicos;
    }

    public void setTrabalhosTecnicos(List<TrabalhoTecnicoVO> trabalhosTecnicos) {
