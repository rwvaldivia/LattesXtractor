...
public class ApresentacaoTrabalho {
    ...
    private List<TrabalhoApresentadoVO> trabalhosApresentados;

    public List<TrabalhoApresentadoVO> getTrabalhosApresentados() {
        return trabalhosApresentados;
    }

    public void setTrabalhosApresentados(List<TrabalhoApresentadoVO> trabalhosApresentados) {
