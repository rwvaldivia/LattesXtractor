...
public class OrientacaoIniciacaoCientificaConcluida {
    private List<IniciacaoCientificaVO> orientacoesIniciacaoCientificaConcluida;

    public List<IniciacaoCientificaVO> getOrientacoesIniciacaoCientificaConcluida() {
        return orientacoesIniciacaoCientificaConcluida;
    }

    public void setOrientacoesIniciacaoCientificaConcluida(List<IniciacaoCientificaVO> orientacoesIniciacaoCientificaConcluida) {
