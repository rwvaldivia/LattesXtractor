...
public class ArtigosEmRevistas {
    private List<ArtigoRevistaVO> artigosEmRevistas;

    public List<ArtigoRevistaVO> getArtigosEmRevistas() {
        return artigosEmRevistas;
    }

    public void setArtigosEmRevistas(List<ArtigoRevistaVO> artigosEmRevistas) {
        this.artigosEmRevistas = artigosEmRevistas;
    }
