 ...
 * @author richardv
 */
public class ProducaoArtistica {
    private List<ProducaoVO> producaoArtistica;

    public List<ProducaoVO> getProducaoArtistica() {
        return producaoArtistica;
    }

    public void setProducaoArtistica(List<ProducaoVO> producaoArtistica) {
