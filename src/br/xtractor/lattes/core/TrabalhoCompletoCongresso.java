 ...
 * @author richardv
 */
public class TrabalhoCompletoCongresso {
    private List<TrabalhoCompletoVO> trabalhoCompletoCongresso;

    public List<TrabalhoCompletoVO> getTrabalhoCompletoCongresso() {
        return trabalhoCompletoCongresso;
    }

    public void setTrabalhoCompletoCongresso(List<TrabalhoCompletoVO> trabalhoCompletoCongresso) {
