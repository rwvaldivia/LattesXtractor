...
public class OrientacaoOutrosTiposConcluida {
    private List<OrientacaoOutrosTiposVO> orientacoesOutrosTiposConcluida;

    public List<OrientacaoOutrosTiposVO> getOrientacoesOutrosTiposConcluida() {
        return orientacoesOutrosTiposConcluida;
    }

    public void setOrientacoesOutrosTiposConcluida(List<OrientacaoOutrosTiposVO> orientacoesOutrosTiposConcluida) {
