 ...
 * @author richardv
 */
public class SupervisaoPosDoutoradoAndamento {
    List<SupervisaoVO> supervisoesDoutAndamento;

    public List<SupervisaoVO> getSupervisoesDoutAndamento() {
        return supervisoesDoutAndamento;
    }

    public void setSupervisoesDoutAndamento(List<SupervisaoVO> supervisoesDoutAndamento) {
