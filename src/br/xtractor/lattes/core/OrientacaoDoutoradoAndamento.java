...
public class OrientacaoDoutoradoAndamento {
    private List <TeseVO> orientacoesDoutoradoEmAndamento;

    public List<TeseVO> getOrientacoesDoutoradoEmAndamento() {
        return orientacoesDoutoradoEmAndamento;
    }

    public void setOrientacoesDoutoradoEmAndamento(List<TeseVO> orientacoesDoutoradoEmAndamento) {
