 ...
 * @author richardv
 */
public class ProdutoTecnologico {
    private List<ProdutoVO> produtoTecnologico;

    public List<ProdutoVO> getProdutoTecnologico() {
        return produtoTecnologico;
    }

    public void setProdutoTecnologico(List<ProdutoVO> produtoTecnologico) {
