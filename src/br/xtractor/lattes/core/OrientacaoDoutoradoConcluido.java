...
public class OrientacaoDoutoradoConcluido {
    private List <TeseVO> orientacoesDoutoradoConcluidos;

    public List<TeseVO> getOrientacoesDoutoradoConcluidos() {
        return orientacoesDoutoradoConcluidos;
    }

    public void setOrientacoesDoutoradoConcluidos(List<TeseVO> orientacoesDoutoradoConcluidos) {
