 ...
 * @author richardv
 */
public class ProcessoOuTecnica {
    private List <ProdutoVO> processoTecnica;

    public List<ProdutoVO> getProcessoTecnica() {
        return processoTecnica;
    }

    public void setProcessoTecnica(List<ProdutoVO> processoTecnica) {
