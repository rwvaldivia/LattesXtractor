 ...
 * @author richardv
 */
public class ResumoCongresso {
    private List<ResumoCongressoVO> resumoCongresso;

    public List<ResumoCongressoVO> getResumoCongresso() {
        return resumoCongresso;
    }

    public void setResumoCongresso(List<ResumoCongressoVO> resumoCongresso) {
