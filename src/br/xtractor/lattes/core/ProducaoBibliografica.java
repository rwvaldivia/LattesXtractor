...
public class ProducaoBibliografica {
    private List<ProducaoVO> producoesBibliograficas;

    public List<ProducaoVO> getProducoesBibliograficas() {
        return producoesBibliograficas;
    }

    public void setProducoesBibliograficas(List<ProducaoVO> producoesBibliograficas) {
