...
public class ArtigosEmPeriodicos {
    
    private List<ArtigoVO> artigosEmPeriodicos;

    public List<ArtigoVO> getArtigosEmPeriodicos() {
        return artigosEmPeriodicos;
    }

    public void setArtigosEmPeriodicos(List<ArtigoVO> artigosEmPeriodicos) {
