...
public class OrientacaoMonografiaEspecializacaoAndamento {
    
    private List<MonografiaVO> orientacaoMonograiaEspecializacaoAndamento;

    public List<MonografiaVO> getOrientacaoMonograiaEspecializacaoAndamento() {
        return orientacaoMonograiaEspecializacaoAndamento;
    }

    public void setOrientacaoMonograiaEspecializacaoAndamento(List<MonografiaVO> orientacaoMonograiaEspecializacaoAndamento) {
