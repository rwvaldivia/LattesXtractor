 ...
 * @author richardv
 */
public class ResumoCongressoExpandido {
    
    private List<ResumoCongressoExpandidoVO> resumoCongressoExpandido;

    public List <ResumoCongressoExpandidoVO> getResumoCongressoExpandido() {
        return resumoCongressoExpandido;
    }

    public void setResumoCongressoExpandido(List<ResumoCongressoExpandidoVO> resumoCongressoExpandido) {
